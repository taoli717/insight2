...
public class PatternMatrixServiceImpl implements PatternMatrixService {
    ...
    @Override
    public PatternMatrix parseRawPatternModel(RawPatternModel rpm) {
    ...
    public RealMatrix generateDiffMeanMatrix(List<Double> highs, List<Double> lows, List<Double> opens, List<Double> closes, List<Double> volumns ){
    ...
    public RealMatrix generatePercentMatrix(List<Double> highs, List<Double> lows, List<Double> opens, List<Double> closes, List<Double> volumns ){
    ...
    public RealMatrix generateMatrix(List<Double> highs, List<Double> lows, List<Double> opens, List<Double> closes, List<Double> volumns ){

        double[][] doubles = new double[5][highs.size()];
